...
export default function Services(){
    return(
       ...
       <p className="font-serif text-white p-5 text-center text-xl sm:text2xl md:text-3xl lg:text-4xl xl:text-5xl md:py-20 bg-center "style={{ backgroundImage: 'url("services.jpg")',}}>
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 p-4 md:px-20 xl:px-40 bg-cover" style={{ backgroundImage: 'url("contact-bg.jpg")' }}>
        {Service.map((data) => (
